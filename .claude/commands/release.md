...
Release a new version of Sessylph with automatic version bump and release notes.
...
Display:
- New version number
- Release URL: `https://github.com/Saqoosha/Sessylph/releases/tag/v<new_version>`
